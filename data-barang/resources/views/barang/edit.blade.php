    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="col-12 col-md-7 col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.barang.update', $barang->id)}}" method="post" autocomplete="off"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('storage/' .$barang->gambar)}}"
                                                    class="preview img-fluid mb-2 col-sm-5" style="display: block">
                                                @else
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="harga" class="form-control"
                                                    value="{{ $barang->harga ??''}}" min="1">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="">Jumlah</label>
                                                <input type="number" value="{{ $barang->jumlah ??''}}" name="jumlah"
